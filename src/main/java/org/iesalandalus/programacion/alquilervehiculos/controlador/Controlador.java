...
public class Controlador {
	...
	public void devolverAlquilerCliente(Cliente cliente, LocalDate fechaDevolucion)
			throws OperationNotSupportedException {
		modelo.devolver(cliente, fechaDevolucion);
	}

	public void devolverAlquilerVehiculo(Vehiculo vehiculo, LocalDate fechaDevolucion)
			throws OperationNotSupportedException {
